...
export const useUserFilters = ({ cond, setCondition, page, limit }: UseUserFiltersProps) => {
  ...
  const handleFilter = useCallback(() => {
    ...
    if (filterValues.fullName === undefined) delete newCond.fullName;
    if (filterValues.email === undefined) delete newCond.email;
    setCondition(newCond);
