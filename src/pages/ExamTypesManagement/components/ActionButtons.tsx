...
interface ActionButtonsProps {
  ...
  onView: (record: ExamTypeRecord) => void;
...
const ActionButtons = memo(({ record, onView, onEdit, onDelete }: ActionButtonsProps) => (
  <>
    <Access permission={ALL_PERMISSIONS.EXAM_TYPES?.GET_BY_ID} hideChildren={true}>
      <Button
        title="Xem chi tiết"
        icon={<EyeOutlined />}
    ...
    <Access permission={ALL_PERMISSIONS.EXAM_TYPES?.UPDATE} hideChildren={true}>
      <Button
        title="Chỉnh sửa"
        icon={<EditOutlined />}
        type="primary"
    ...
    <Access permission={ALL_PERMISSIONS.EXAM_TYPES?.DELETE} hideChildren={true}>
      <Popconfirm
